...
```bash
pip install numpy matplotlib seaborn "gymnasium[toy-text]"
```
...
Feel free to fork this repo and tweak the hyperparameters (`alpha`, `gamma`, `epsilon`) in
each notebook to see how they affect learning speed and behavior.
